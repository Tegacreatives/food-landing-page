    ...
    <footer className="footer">
            ...
            <Col lg="3" md="4" sm="6">
              ...
              <ListGroup>
                <ListGroupItem className="link__item d-flex align-items-center gap-3">
                  <i class="ri-map-pin-line"></i> Edo State, Nigeria{" "}
                </ListGroupItem>

                <ListGroupItem className="link__item d-flex align-items-center gap-3">
                  <i class="ri-mail-line"></i> contact@tegacreatives.com{" "}
                </ListGroupItem>

                <ListGroupItem className="link__item d-flex align-items-center gap-3">
                  <i class="ri-phone-line"></i> +234 805 477 8290
                </ListGroupItem>
              </ListGroup>
            </Col>
          </Row>
      ...
      <div className="footer__bottom">
        <Container>
          <Row>
            <Col lg="12">
              <p>copyright 2022, developed by Tega Creatives. All rights reserved</p>
            </Col>
          </Row>
        </Container>
      </div>
